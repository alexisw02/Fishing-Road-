...
def nivel1facil_():
    ...
    #fondomenu_pausa = pygame.image.load('imagenes/Botones/gamepaused.png').convert_alpha()
        ...
        if game_paused == False:
            ...
            if menu_state == "fondopausa":
                ...
                if restart_boton1.draw(screen):
                    menu_state = "objetivomis"

            if menu_state == "objetivomis":
                screen.blit(lago, (0,0))
