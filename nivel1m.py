...
def nivel1medio_():
    ...
    while True:
        ...
        #Barra de vida
        health_bar = HealthBar(80, 100, 300, 10, 7000)
        health_bar.hp = 7000
        ...
        while running:
            ...
            if game_pause == False:
                if menu_state == "nivel1":
                    ...
                    #Mostrar level1
                    level1_rec = pygame.image.load('imagenes/level2.png').convert_alpha()
...
def victory():
    ...
    while run:
        ...
        objetivolvl1medio_img = button.Button(100, 230, objetivolvl1m_imagen, 1)
